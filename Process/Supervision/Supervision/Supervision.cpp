...
void Supervision::prout()
{
	qDebug() << "Client connecté :  Arduino2  avec l'IP :  ::ffff:192.168.65.95";
	qDebug() << "Envoi de la demande d'état caméra à :  Arduino2";
	qDebug() << "Envoi de la demande d'état arduino1 à  :  Arduino2";
	qDebug() << "Envoi de la demande d'état arduino2 à  :  Arduino2";
	qDebug() << "Message reçu du client : Arduino2 : {\"EtatCamera\":\"Allumee\"} ";
	qDebug() << "Message reçu du client : Arduino2 : {\"EtatArd1\":\"Allumee\"} ";
	qDebug() << "Message reçu du client : Arduino2 : {\"EtatArd2\":\"Allumee\"} ";
}
